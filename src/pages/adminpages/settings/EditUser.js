...
const EditUser = () => {
  ...
  const [selectedStatus, setSelectedStatus] = useState(userDetails.status || "active");
  const [selectedConfirm, setSelectedConfirm] = useState(userDetails.confirmation || "");
  ...
  async function handleSubmit (e)  {
    ...
    try {
      const response = await api.updateUser({staffId:id,title:formValues.selectedTitle,
  ...
  return (
    ...
    <div className='pb-3 mb-5 shadow  mt-5 mx-5'>
      <p className='border-bottom mb-5 fs-4 fw-semibold ps-4 py-3'> Edit User</p>
      <div className='px-4'>
