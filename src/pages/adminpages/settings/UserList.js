...
const UserList = () => {
  ...
  const roles = [
    ...
    { name: "Head of ASE", value: "PT" },
    { name: "Head of NASE Junior", value: "HASEJ" },
    { name: "Head of NASE Senior", value: "HASES" },
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      enqueueSnackbar("Role Assigned to Staff successfully", { variant: "success" });
      setLoading(false);
                          ...
                          <Menu>
                            ...
                            <MenuList maxW="32" className="">
                              ...
                              <MenuItem
                                ...
                                color="#bf0d0d"
                                mb="10px"
                                onClick={() => {handelAssignStaff(user.id) }}
                              >
                                <HiUserAdd
                                  color="#98A2B3"
                                  size="16"
              ...
              >
                ...
                <ModalContent>
                  ...
                  <ModalFooter>
                    ...
                    <Button onClick={()=> setIsAssignModal(false)}>close</Button>
                  </ModalFooter>
                </ModalContent>
              </Modal>
            </div>
